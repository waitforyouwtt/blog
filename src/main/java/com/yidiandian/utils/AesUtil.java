 ...
 * AES 加密[Base64Decoder & Base64Encoder]
 */
@Slf4j
public class AesUtil {
    ...
    public static void main(String[] args) {
        String mingwen = "你好啊";
        log.info("明文是：{}",mingwen);
        //String miyao = generateKey();
        String key = "D18930976E9AE42D66B0DD5E272A38F8B5C79164";
        log.info("生成的秘钥：{}"+key);
        String encrypt = encrypt(key, mingwen);
        log.info("加密后：{}",encrypt);
        String mingweno = " Vaj9SafHSsDysinJj8Jl3A==";
        String decrypt = decrypt(key, mingweno);
        log.info("解密：{}",decrypt);
    }
}
